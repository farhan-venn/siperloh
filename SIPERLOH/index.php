      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-sm-6">
            ...
            <hr>
              <p><a class="btn btn-primary btn-lg" href="#" role="button">Koleksi Buku</a>
              <a class="btn btn-primary btn-lg" href="#" role="button">Data peminjaman</a></p>
          ...
          <div class="container">
            <div class="row">
              ...
              <p class="text-center">Website Siperloh(Sistem Perpustakaan SMAN 1 Lohbener) ini berfungsi sebagai sumber 
                informasi digital yang menyimpan lokasi koleksi buku,jurnal,artikel,dan materi pendidikan lainnya yang relevan dab ada di SMAN 1 Lohbener
                <br>
                <br>

                Website Siperloh adalah platfrom online yang dibuat untuk memberikan akses kepada siswa,guru,dan staf perpustakaan.
                <br>
                <br>

                Tujuan utama website ini adalah untuk meningkatkan aksesibilitas terhadap sumber-sumber pendidikan,mendukung pembelajaran, dan memfasilitasi penelitian siswa dan pengajar.
                <br>
                <br>

                Website Siperloh dapat diakses kapan saja selama 24jam sehingga memberikan akses yang lebih fleksibel bagi penggunanya 
