...
<html lang="en">
  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav navbar-right">
            <li style="width: 120px;"><a href="index.html" class="page-scroll">Home</a></li>
            <li style="width: 120px;"><a href="login.html">Admin</a></li>
            <li style="width: 120px;"><a href="index.html" class="page-scroll">Tentang</a></li>
            <li style="width: 120px;"><a href="index.html" class="page-scroll">Kontak</a></li>
          </ul>
        </div>
      </div>
    </nav>
    ...
    <div class="container">
        <div class="row my-5">
          <div class="login">
            <div class="col-md-6 text-center login" style="background-image: url('images/memphis-colorful.png');">
